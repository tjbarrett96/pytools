...
# TODO: just make Node.anchors these rules, and access positions exclusively through __getitem__, calculated on the fly
...
# box corner radius for shape "round"
...
class Node:
  ...
  def __init__(
    self,
    size: Number | tuple[Number, Number] | Self | Iterable[Self] = 1,
    shape: str = "round",
    anchor: str = "c",
    margin: float = 0.15,
    pad: float = 0.15,
